// Extension: lyrics-canvas
// Canvas for custom lyrics paste and word definitions — scaffold for PR #16
//
...
function renderHtml(instanceId) {
    return `<!doctype html>
<html>
  <head><meta charset="utf-8" /><title>lyrics-canvas</title></head>
