...
import { FieldLinesRenderer } from '../bg/fieldlines';
import { webglAvailable } from '../bg/ocean';
import { useSettings } from '../state/settings';

export function FieldLinesBackground(): JSX.Element {
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const rendererRef = useRef<FieldLinesRenderer | null>(null);
  ...
  useEffect(() => {
    ...
    const renderer = new FieldLinesRenderer(canvas, {
